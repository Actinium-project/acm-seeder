...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Actinium-seeder\n"
...
static const string mainnet_seeds[] = {"api.actinium.org", "actinium.org","goldmine.actinium.org","seeder1.shit.supply", ""};
static const string testnet_seeds[] = {"seeder1-test.shit.supply", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    // db.Add(CService("104.156.231.46", GetDefaultPort()), true);
    // db.Add(CService("45.63.92.210", GetDefaultPort()), true);
  }
  do {
